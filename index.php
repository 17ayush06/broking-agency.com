...
<head>
  ...
  <title>Azino - A Broking Agency</title>
    ...
    <div class="header-top">
      <div class="container">
        ...
        <ul class="header-top-list">
          ...
          <li>
            <a href="mailto:aayushkhambayate123@gmail.com" class="header-top-link">
              <ion-icon name="mail-outline"></ion-icon>

              <span>aayushkhambayate123@gmail.com</span>
            </a>
          </li>
      ...
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <ul class="contact-list">
            ...
            <li>
              <a href="tel:9307249795" class="contact-link">
                <ion-icon name="call-outline"></ion-icon>

                <span>9307249795</span>
              </a>
            </li>

            <li>
              <a href="mailto:aayushkhambayate123@gmail.com" class="contact-link">
                <ion-icon name="mail-outline"></ion-icon>
